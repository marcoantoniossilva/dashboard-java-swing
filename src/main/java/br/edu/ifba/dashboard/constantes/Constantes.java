...
public class Constantes {
    ...
    public static final String URL_SERVIDOR_GRAPHQL_UFS = "http://localhost:4001";
    public static final String URL_SERVIDOR_GRAPHQL_CIDADES = "http://localhost:4002";
    public static final String URL_SERVIDOR_GRAPHQL_BAIRROS = "http://localhost:4003";
